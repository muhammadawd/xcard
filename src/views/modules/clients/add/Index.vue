    ...
    <form>
      <fieldset class="fieldSetMain">
        ...
        <vx-card>
          ...
          <div class="vx-row mb-2">
            <div class="vx-col w-full md:w-1/3 mb-2">
              <label class="vs-input--label">{{$t('password')}} <span class="star">*</span></label>
              <vs-input v-validate="'required'" class="w-full" name="password" type="password"
                        :danger="errors.has('password')" val-icon-danger="close"
                        autocomplete="off" v-model="dataModel.password"/>
              <span class="text-danger text-sm" v-show="errors.has('password')">{{ errors.first('password') }}</span>
            </div>
            <div class="vx-col w-full md:w-1/3 mb-2">
              <label class="vs-input--label">{{$t('password_confirmation')}} <span class="star">*</span></label>
              <vs-input v-validate="'required'" class="w-full" type="password"
