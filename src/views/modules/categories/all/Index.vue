  ...
  <div id="ag-grid-demo">
        ...
        <vs-col vs-type="flex" vs-justify="flex-end" vs-align="center" vs-w="6">
          <div class="btn-group flex">
            <vs-button size="small" type="line" color="primary" icon-pack="feather" icon="icon-plus" class="mb-0"
                       @click="$router.push({name:'add-category'})">{{$t('add')}}
            </vs-button>
    ...
    <div>
      ...
      <vs-table :data="users">
        ...
        <template slot="thead">
          <vs-th>#</vs-th>
          <vs-th>{{$t('category_name')}}</vs-th>
          <vs-th>{{$t('category_parent')}}</vs-th>
          <vs-th>{{$t('slug')}}</vs-th>
          <vs-th>{{$t('category_parent')}}</vs-th>
            ...
            <vs-tr class="bg-white">
              <vs-td>
                <vs-button size="small" color="primary" icon-pack="feather" icon="icon-edit"
                           @click="$router.push({name:'edit-category',params:{id:tr.id}})">{{$t('edit')}}
                </vs-button>
              </vs-td>
              <vs-td></vs-td>
              <vs-td></vs-td>
              ...
              <vs-td>
                <div class="btn-group flex">
                  ...
                  <vs-button type="line" size="small" class="p-0" color="warning" icon-pack="feather" icon="icon-eye"
